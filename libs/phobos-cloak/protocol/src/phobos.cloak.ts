...
export const Request = {
  encode(message: Request, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.getClusterMixingMatrix !== undefined) {
      GetClusterMixingMatrix_Request.encode(message.getClusterMixingMatrix, writer.uint32(10).fork()).ldelim();
    }
    if (message.setClusterMixingMatrix !== undefined) {
      SetClusterMixingMatrix_Request.encode(message.setClusterMixingMatrix, writer.uint32(18).fork()).ldelim();
    }
    if (message.setPhasePower !== undefined) {
      SetPhasePower_Request.encode(message.setPhasePower, writer.uint32(26).fork()).ldelim();
    }
    if (message.getPhasePower !== undefined) {
      GetPhasePower_Request.encode(message.getPhasePower, writer.uint32(34).fork()).ldelim();
    }
    ...
    if (message.getTargetPhasePower !== undefined) {
      GetTargetPhasePower_Request.encode(message.getTargetPhasePower, writer.uint32(50).fork()).ldelim();
    }
    ...
    if (message.setTargetPhasePower !== undefined) {
      SetTargetPhasePower_Request.encode(message.setTargetPhasePower, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
...
export const Response = {
  encode(message: Response, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.getClusterMixingMatrix !== undefined) {
      GetClusterMixingMatrix_Response.encode(message.getClusterMixingMatrix, writer.uint32(10).fork()).ldelim();
    }
    if (message.setClusterMixingMatrix !== undefined) {
      SetClusterMixingMatrix_Response.encode(message.setClusterMixingMatrix, writer.uint32(18).fork()).ldelim();
    }
    if (message.setPhasePower !== undefined) {
      SetPhasePower_Response.encode(message.setPhasePower, writer.uint32(26).fork()).ldelim();
    }
    if (message.getPhasePower !== undefined) {
      GetPhasePower_Response.encode(message.getPhasePower, writer.uint32(34).fork()).ldelim();
    }
    if (message.getTargetClusterMixingMatrix !== undefined) {
    ...
    if (message.getTargetPhasePower !== undefined) {
      GetTargetPhasePower_Response.encode(message.getTargetPhasePower, writer.uint32(50).fork()).ldelim();
    }
    if (message.setTargetClusterMixingMatrix !== undefined) {
    ...
    if (message.setTargetPhasePower !== undefined) {
      SetTargetPhasePower_Response.encode(message.setTargetPhasePower, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
...
function createBaseCloakMessage(): CloakMessage {
  return { id: "", request: undefined, response: undefined, error: undefined };
}

export const CloakMessage = {
  encode(message: CloakMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CloakMessage {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCloakMessage();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CloakMessage {
    return {
  ...
  toJSON(message: CloakMessage): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<CloakMessage>, I>>(base?: I): CloakMessage {
    return CloakMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CloakMessage>, I>>(object: I): CloakMessage {
    const message = createBaseCloakMessage();
